...
export interface DashboardPageViewProps {
  ...
  isChatCloseConfirmOpen: boolean;
  onChatBackgroundClick: () => void;
    ...
    <div className="relative min-h-screen bg-background-tertiary">
      ...
      <div className={`transition-all duration-300 ease-in-out ${isSidebarOpen ? 'ml-64' : 'ml-0'}`}>
        ...
        <main className="p-8 pt-24">
          {reviewCardsError ? (
            <NetworkErrorPage onRetry={onRetryFetch} />
          ) : (
            <>
                ...
                backlogCards.map((card) => (
                  <ReviewCard
                    ...
                    tags={[
                      ...
                      { label: '중요도', value: `${card.importance}/10` },
      ...
      <ConfirmModal
        isOpen={isChatCloseConfirmOpen}
        title="대화 종료"
        message="작성 중인 내용이 사라집니다. 종료하시겠습니까?"
        onConfirm={onConfirmChatClose}
        onCancel={onCancelChatClose}
        isLoading={false}
        confirmText="종료"
        cancelText="취소"
      />
